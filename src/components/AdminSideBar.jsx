...
const AdminSideBar = () => {
  ...
  if (nav) {
    return (
        <div className="">
          <aside className="flex gap-1 h-screen flex-col border-r border-Lichtgrijs top-0 left-0  pr-3">
    ...
    return (
      <aside className="flex gap-1 flex-col h-screen max-w-20 border-r border-Lichtgrijs top-0 left-0 ">
        <a href="/admin/Dashboard">
          <header className="flex w-full h-20 gap-x-5 items-center  ">
            <img
              src={ehbLogo}

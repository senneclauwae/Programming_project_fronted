    ...
    <content className="flex top-0 flex-grow">
      <main className="flex-grow p-10">
        ...
        <div className="flex w-full h-screen">
          <table className="w-full mt-4 h-screen  ">
            <thead className="w-full h-16">
              <tr className="text-sm text-Grijs font-thin ">
                <th
                  scope="col"
                  className="py-3 px-6 w-hover:cursor-pointer "
                >
                  Nr
                </th>
                <th
            ...
            <tbody>
              {productModellen.map((model) => (
                <tr
                  key={model.productModelNr}
                  className="border"
                >
                  <td className="flex justify-center">{model.productModelNr}</td>
                  <td className=" items-center">
                    <div className="flex h-full item-center">
                      <div className="h-16 auto">
                      <img
                        src={canonFoto}
                        alt=""
                        className=""
